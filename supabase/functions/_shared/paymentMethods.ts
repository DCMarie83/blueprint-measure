// Deno twin of src/lib/paymentMethods.js — one content model for payment
// options, feeding send-invoice-email, send-lite-invoice-email, and
// send-estimate-email. Keep the two files' logic and the fixture below
// identical.
//
