...
export const tryStrings = {
  ...
  peeks: {
    ...
    es: {
      ...
      scarcityCap: 'Solo {n} lugares de fundador por estado.',
      scarcityCapSub: 'Cuando {state} se llene, el precio sube.',
      scarcityLeftOne: 'Solo queda {n} lugar de fundador en {state}.',
      scarcityLeftMany: 'Solo quedan {n} lugares de fundador en {state}.',
      scarcityGone: 'Los lugares de fundador en {state} se agotaron - únete en {tier} por ${price}/mes.',
    },
  },
